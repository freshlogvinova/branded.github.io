function JSUploader() {
    ...
    this.addFiles = function(files) {
        $.each(files, function(i, file) {
            ...
            temp.valid = (file.type == 'image/png'
                ...
                || file.type == 'image/jpg'
                || file.type == 'video/mp4') && file.size / 1024 / 1024 < 60;
    ...
    this.attachFileToView = function(file) {
          ...
          var isValidSize = file.file.size / 1024 / 1024 < 60;
          ...
          if(!isValidSize) {
            messageColumn.html(messageColumn.html() + 'File size is ' + Math.floor(file.file.size / 1024 / 1024) + ' MB. Limit is 60 MB.');
          }
